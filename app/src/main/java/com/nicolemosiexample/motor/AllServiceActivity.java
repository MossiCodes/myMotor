...
public class AllServiceActivity extends AppCompatActivity {
        ...
        mDatabase.orderByChild("email").equalTo(email).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if( dataSnapshot.exists() ) {
                    ...
                    Toast.makeText( com.nicolemosiexample.motor.AllServiceActivity.this, "Email not found", Toast.LENGTH_SHORT ).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText( com.nicolemosiexample.motor.AllServiceActivity.this, "Ref cancelled", Toast.LENGTH_SHORT ).show();
            }
        });
    }
    ...
    public void processDatePickerResult(int i, int i1, int i2) {
    }
}